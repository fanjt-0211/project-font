  ...
  <el-card>
    ...
    <el-form :inline="true" :model="query" @submit.prevent="fetchData">
      <el-form-item label="出库单号">
        <el-input v-model="query.outboundNo" placeholder="模糊搜索" clearable />
      </el-form-item>
    ...
    <el-dialog title="新增出库" v-model="dialogVisible" width="500px">
      <el-form :model="form" :rules="rules" ref="formRef" label-width="80px">
        ...
        <el-form-item label="单价">
          ...
          <span style="color:#909399;font-size:12px">留空则取物资销售价</span>
        </el-form-item>
...
const openDialog = () => {
  Object.assign(form, { type: 1, materialId: null, warehouseId: null, quantity: 1, unitPrice: null, recipient: '', department: '', remark: '' })
